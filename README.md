...
```
https://cdn.staticdelivr.com/gh/hallobayi/assets/1.2.7/vendors/jquery/jquery.min.js
```
...
```html
<script src="https://cdn.staticdelivr.com/gh/hallobayi/assets/1.2.7/vendors/jquery/jquery.min.js"></script>
```

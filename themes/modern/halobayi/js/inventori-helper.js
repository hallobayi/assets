...
function popUpKirimKeCabang( idFrm ) {
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: base_url+'inventori/ajaxUpdateKirimBarang?unik_id='+idFrm,
    ...
    $.get(base_url+'inventori/ajaxFormKirimBarang?unik_id='+idFrm, function(html) {
...
$(document).ready(function(){
    console.log('Init Module Inventori Helper');
});
// Source: https://codepen.io/chucky25/pen/dBevXW || https://jsfiddle.net/B9EWd/ || https://jsfiddle.net/9Gshb/1/
...
// use:  $('input:text[name=terbilang_jumlah_harus_bayar]').val(terbilang(Number(jumlah_diskon)));
// source: khanza-lite

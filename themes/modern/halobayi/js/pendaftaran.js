...
jQuery(document).ready(function () {
  ...
  const column =
    typeof $("#pendaftaran-column").html() === "string"
      ? $.parseJSON($("#pendaftaran-column").html())
      : {};
    ...
    fnRowCallback: function (nRow, aoData, c) {
      ...
      $("td", nRow)
        ...
        .html(
          "<b>" +
            aoData["nama_pasien"] +
            ' </b><i style="color: #28c0e5" class="fa fa-venus"></i><br/><span class="label label-success">NIK: ' +
            aoData["HC_pasien#nik"] +
      ...
      $("td", nRow)
        ...
        .html(
          '<b><i style="color: #00a65a !important" class="fa-solid fa-user-doctor"></i> ' +
            ...
            '</b><br /><i style="color: #00a65a !important" class="fa-solid fa-building"></i><span class="label label-success"> ' +
            aoData["nama_cabang"] +
  ...
  $("#form-pendaftaran").submit(function (e) {
    ...
    settings.ajax.url =
      base_url +
      "pendaftaran/getDataPendaftar?startDate=" +
      startDate +
      "&endDate=" +
      endDate +
      "&lokasi=" +
  ...
  const klikDetail = (id) => {
    ...
    $.get(
      base_url + "pendaftaran/ajaxKlikDetailKonfirmasiKehadiran?no_reg=" + id,
      function (html) {
  ...
  $("#add-row").on("click", function () {
    ...
    $clone
      .find("a")
      .removeAttr("class")
      .addClass("btn btn-danger delete-row")
      .removeAttr("id")
      .find("i")
      .removeAttr("class")
  ...
  function set_cabang($elm, url) {
    ...
    if ($elm.hasClass("cabang")) {
      ...
      urlCabang =
        "master/dokter/ajaxCabangDokter?kode_cabang=" + value + "&nik=" + null;
    }
  ...
  function set_jadwal($elm, url) {
    ...
    if ($elm.hasClass("nik_dokter")) {
      ...
      urlCabang =
        "master/dokter/ajaxCabangDokter?kode_cabang=" +
        valueCabang +
        "&nik=" +
        value;
    }
